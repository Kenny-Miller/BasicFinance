...
{
    /// <summary>
    /// The <see cref="PagedResponse{T}"/> interface represents a standardized paged response for a query containing a collection of items of type <typeparamref name="T"/>.
    /// </summary>
