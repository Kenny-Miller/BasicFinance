...
namespace BasicFinance.Api.Features.Accounts
{
    ...
    /// <param name="LatestBalance">The latest ledger balance, or <c>null</c> when the account has no ledger entries.</param>
    /// <param name="LatestBalanceRecordedDate">The recorded date of the latest ledger balance, or <c>null</c> when the account has no ledger entries.</param>
